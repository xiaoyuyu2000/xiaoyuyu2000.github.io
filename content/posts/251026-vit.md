...
date = '2025-10-26'
draft = false
title = 'Vit 模型：《An Image is Worth 16x16 Words: Transformers for Image Recognitoin at Scale》论文笔记'
author = 'RR'
tags = ['Transformer', '论文阅读', 'CV']
categories = ['论文阅读']
summary = "Vit 模型：《An Image is Worth 16x16 Words: Transformers for Image Recognitoin at Scale》论文笔记"
+++
